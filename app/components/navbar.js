...
export default function Navbar() {
    ...
    return (
        <nav className='py-10 mb-8 lg:mb-12 flex justify-between'>
            ...
            <div className="flex">
                <ul className={`sm:flex items-center hidden sm:mr-4`}>
                    ...
                    <li>
                        <a className='text-the-red mr-6 hover:text-the-off-white hover:bg-the-red transition duration-300' href="/mail">contact</a>
                    </li>
                    <li>
